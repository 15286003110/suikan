...
class InitializerNativeCallable {
  ...
  void dispose(Pointer<generated.mpv_handle> ctx) {
    ...
    // (upstream media_kit 1.2.6 fix, backported to vendored 1.2.0;
    //  Flutter 3.38+ destroys NativeCallable trampolines while mpv thread
    //  still runs → "Callback invoked after it has been deleted" SIGABRT).
